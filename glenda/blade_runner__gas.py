...
from data.data_load import load_gas

#
data_gas = load_gas()

data_gas_pct = data_gas.pct_change(fill_method=None).dropna()
...
result = test_eg(ts1=data_gas_pct['Close/Last__GASNCOMPANY'].values, ts2=data_gas_pct['Close/Last__GAS'].values, **kwg)
